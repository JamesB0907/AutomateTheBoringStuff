...
for amer_filenames in os.listdir('.'):
    mo = date_pattern.search(amer_filenames)
...
amer_filenames = os.path.join(abs_working_dir, amer_filenames)
euro_filename = os.path.join(abs_working_dir, euro_filename)
# Rename the files.
print(f'Renaming "{amer_filenames}" to "{euro_filename}"...')
#shutil.move(amer_filenames, euro_filename) # uncomment after testing
